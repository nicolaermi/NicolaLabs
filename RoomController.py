...
class RoomController:
    ...
    def __init__(self):
        ...
        # do the handling
        self._button = Button(16, "button1", buttonhandler=None)
        self._partybutton = Button(17, "button2", buttonhandler=None)

        self._timer = SoftwareTimer(None)
        self._light = Light(0,'roomlight')
        self._partylight = NeoPixel(pin=1,numleds=8,brightness=1)
